...
export class HivProgramSnapshotComponent implements OnInit {
  ...
  //       ADULTRETURN                                  ---- 8d5b2be0-c2cc-11de-8d13-0010c6dffd0f
  //       MORISKY 4 MEDICATION ADHERENCE, TOTAL SCORE  ---- 315472dc-2b5e-4add-b3b7-bbcf21a8959b
...
// Function to get NUll Morisky score
  public getNullMorisky() {
    this.moriskyScore = ' ';
    this.MoriskyDenominator = ' ';
    this.moriskyRating = 'No value';
    console.log('There is no moriskyScore4 or moriskyScore8');
  }
